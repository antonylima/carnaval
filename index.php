                ...
                <div class="card-body">
                    <div class="info-row">
                        ...
                        <div>
                            ...
                            <span class="info-text">${item.hora}</span>
                        </div>
                    </div>
                    <div class="info-row">
                        <svg class="info-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div>
                            ...
                            <span class="info-text">${item.local}</span>
                        </div>
                    </div>
                    <div class="badge">${item.bairro}</div>
                    
                    <div class="card-actions">
                        <a href="https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(item.local + ', ' + item.bairro + ', Fortaleza, CE')}" target="_blank" class="btn-action btn-maps">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg>
                        ...
                        <a href="https://m.uber.com/ul/?action=setPickup&pickup=my_location&dropoff[formatted_address]=${encodeURIComponent(item.local + ', ' + item.bairro + ', Fortaleza, CE')}" target="_blank" class="btn-action btn-uber">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="M12 2a10 10 0 0 1 10 10 10 10 0 0 1-10 10 10 10 0 0 1-10-10 10 10 0 0 1 10-10z" fill="white" stroke="none"/>
                                <path d="M9 12h6" stroke="black" stroke-width="2"/>
                            </svg>
                            Uber
                        </a>
                    </div>
